...
if(isset($parameters)){
	...
	if(JSONCorrectoAnnadir($mensajeRecibido)){
		...
		$caracteristica = $mensajeRecibido["caracteristica"];
		
		$query  = "UPDATE  elementos SET nombre='$nombre',descripcion='$descripcion',caracteristica='$caracteristica' WHERE id=$id ";
